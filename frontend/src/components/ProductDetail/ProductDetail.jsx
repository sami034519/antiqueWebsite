  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        ...
        // ✅ directly set product (your API does not wrap in {status, data})
        setProduct(data);
  ...
  return (
    <div className="container mt-20 mx-auto px-4 py-10 grid grid-cols-1 md:grid-cols-2 gap-10">
      ...
      <div className="flex justify-center">
        <img
          src={`https://antiques.minnaminnie.com/${product.image}`} // ✅ fixed
          alt={product.title}
      ...
      <div className="flex flex-col justify-center space-y-6">
        ...
        <button className="relative w-full md:w-1/2 overflow-hidden bg-yellow-600 rounded-2xl shadow-md group">
